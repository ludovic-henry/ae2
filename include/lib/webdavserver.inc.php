...
//
require_once($topdir."include/lib/webdav/_parse_propfind.inc.php");
require_once($topdir."include/lib/webdav/_parse_proppatch.inc.php");
require_once($topdir."include/lib/webdav/_parse_lockinfo.inc.php");
